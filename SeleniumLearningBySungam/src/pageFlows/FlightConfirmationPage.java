...
public class FlightConfirmationPage {
	...
	public void conFirmationMsg(WebDriver driver) {
		...
		String ActualValue = op.getText(driver, FlightConfirmationObj.text_Confirmation);
		String Expectedvalue = "Your itinerary has been booked!";
		if (Expectedvalue.equals(ActualValue)) {
			System.out.println("=============FlightBookConfirmation==================");
			System.out.println("Pass - Book confirmation is= " + Expectedvalue);
			System.out.println("============================================");
		} else
			System.out.println("Failed - Book confirmation");

	}

	public void confirmationNumber(WebDriver driver) {
		System.out.println("===================ConfirmationNo=========================");
		String confirmationNo = op.getText(driver, FlightConfirmationObj.text_FlightConfirmNo);
		System.out.println(confirmationNo);
		System.out.println("=================ConfirmationDateAndTime===========");
		String Actual_confirmationDate = op.getText(driver, FlightConfirmationObj.text_FlightConfirmDateAndTime);	
		System.out.println("Flight Confirmation date and time # "+Actual_confirmationDate);
		// op.clickLink(driver, FlightConfirmationObj.link_Logout);
	...
	public void validation_Confirm(WebDriver driver) {
		...
		System.out.println("======================FlightConfirmationinfo======================");
